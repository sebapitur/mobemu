...
ml_focus_df = ml_df[ml_df["dissemination"]==True]
epidemic_df = epidemic_df[epidemic_df["dissemination"]==True]
spray_focus_df = spray_focus_df[spray_focus_df['dissemination'] == True]
